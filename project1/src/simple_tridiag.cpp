...
//  The algorithm assumes A is a special tridiagonal matrix, with 2's along the main 
//  diagonal and -1's directly above and below the main diagonal.
...
int main(int argc, char *argv[]){
	...
	double time;		         // place holders for relative error, time
