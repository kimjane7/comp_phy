...
int main(int argc, char *argv[]){
	...
	CPlanet earth("Earth", 3.0E-6, 0.93599, 0.35658, -1.4878, -2.3125, 5.8624, -4.2158E-4);
	...
	CPlanet neptune("Neptune", 5.15E-5, 28.611, -8.8304, -0.47753, 0.33041, 1.1024, -8.25997);
	CPlanet pluto("Pluto", 6.55E-9, 10.538, -31.714, 0.34537, 1.1162, 0.12426, -0.33748);

	// CSolarSystem system(N, t0, tf, CM frame on);
	CSolarSystem solar_system(3E6, 0.0, 2480, true);
